...
from feedback_module.spelling_rules import Rule_Creole_Ise_To_Ize

rule = Rule_Creole_Ise_To_Ize
...
class Rule_Creole_Ise_To_Ize_Unit_Tests(AssessTestCases.UnitTestCases):
    rule = rule
    combinations_that_follow_rule = combinations_that_follow_rule
    combinations_that_violate_rule = combinations_that_violate_rule

class Rule_Creole_Ise_To_Ize_Integration_Tests(AssessTestCases.IntegrationTestCases):
    rule = rule
